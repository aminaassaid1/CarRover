    ...
    <div class="header_section">
        <div class="container">
         ...
         if (!empty($_SESSION["id_client"])) {
            ...
            ?>
            <nav class="navbar body-tertiary" style="background-color: #1d1d1d;">
                <div class="container-fluid">
...
?>
                ...
                <div class="col-xl-2 col-lg-4 col-md-6 px-2">
                    <div class="date mb-3" id="date" data-target-input="nearest">
                        <input type="date" class="form-control p-4 datetimepicker-input" name="pickup"
                            placeholder="Pickup Date" data-target="#date" data-toggle="datetimepicker" />
                    </div>
                </div>
                <div class="col-xl-2 col-lg-4 col-md-6 px-2">
                    <div class="date mb-3" id="dateoff" data-target-input="nearest">
                        <input type="date" class="form-control p-4 datetimepicker-input" name="dropoff"
                            placeholder="Drop off Date" data-target="#dateoff" data-toggle="datetimepicker" />
                    </div>
                </div>
                <div class="col-xl-2 col-lg-4 col-md-6 px-2">
                    <button class="btn btn-block mb-3" name="sea" type="submit"
                        style="height: 50px; background-color: #fe5b29;">Search</button>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="gallery_section layout_padding">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '        <p class="looking_text">Start per day $' . $row['Prix'] . '</p>';
            echo '        <div class="read_bt"><a href="#">Book Now</a></div>';
            echo '    </div>';
            echo '</div>';
        }
